...
class SubmarineYoutubePlayer extends StatefulWidget {
  final YoutubePlayerController? controller;

  /// Creates a [SubmarineYoutubePlayer] widget.
  const SubmarineYoutubePlayer({
    super.key,
    this.controller,
    this.onEnded,
  });
  ...
  @override
  State<SubmarineYoutubePlayer> createState() => _SubmarineYoutubePlayerState();
}

class _SubmarineYoutubePlayerState extends State<SubmarineYoutubePlayer>
     {
  ...
  Widget build(BuildContext context) {
    controller = widget.controller ?? YoutubePlayerController.of(context);
